                ...
                <form action="{{ route('master.room-types.store') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="name" id="typeName" type="text"
                                placeholder="e.g. Standard Room" required>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="capacity" id="typeCapacity" type="number" placeholder="2"
                                required>
                            <div class="invalid-feedback">Max capacity is required.</div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="typeSize">Room Size (m²)</label>
                            <input class="form-control" name="size" id="typeSize" type="number" placeholder="20"
                                required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" id="typeDesc" rows="3"
                            placeholder="Enter short category description..."></textarea>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="extra_bed_available"
                                    id="extraBedAvail" value="1" checked>
