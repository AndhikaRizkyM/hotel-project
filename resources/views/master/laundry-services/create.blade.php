...
@block('title', 'Add Laundry Service')
...
<div class="row mt-3">
  <div class="col-12 col-md-8 col-lg-6">
    <div class="panel p-4">
      <form action="{{ route('master.laundry-services.store') }}" method="POST" class="needs-validation" novalidate>
        @csrf
        
        <div class="mb-3">
          <label class="form-label" for="serviceName">Service Name</label>
          <input class="form-control" name="name" id="serviceName" type="text" placeholder="e.g. Dry Clean, Wash & Iron" required>
          <div class="invalid-feedback">Service name is required.</div>
        </div>

        <div class="mb-3">
          <label class="form-label" for="servicePrice">Price (Rp)</label>
          <input class="form-control" name="price" id="servicePrice" type="number" placeholder="25000" required>
