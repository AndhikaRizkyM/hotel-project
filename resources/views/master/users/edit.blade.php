    ...
    <div class="row mt-3">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="panel p-4">
                ...
                <form action="{{ route('master.users.update', $user->id) }}" method="POST" class="needs-validation"
                    novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="role" id="userRole" required>
                            ...
                            @foreach ($roles as $r)
                                <option value="{{ $r->name }}"
                                    {{ old('role', $user->role) === $r->name ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="userPassword">Password <small class="text-muted">(leave empty to keep
