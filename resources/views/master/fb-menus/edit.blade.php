...
<div class="row mt-3">
  <div class="col-12 col-md-8 col-lg-6">
    <div class="panel p-4">
      <form action="{{ route('master.fb-menus.update', $menu->id) }}" method="POST" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
        
        <div class="mb-3">
          <label class="form-label" for="menuName">Item Name</label>
          <input class="form-control" name="name" id="menuName" type="text" value="{{ old('name', $menu->name) }}" required>
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="type" id="menuType" required>
            ...
            <option value="beverage" {{ old('type', $menu->type) === 'beverage' ? 'selected' : '' }}>Beverage</option>
          </select>
        ...
        <div class="mb-3">
          ...
          <input class="form-control" name="price" id="menuPrice" type="number" value="{{ old('price', $menu->price) }}" required>
