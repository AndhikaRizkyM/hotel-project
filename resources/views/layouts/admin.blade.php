...
<head>
  ...
  <style>
    ...
    /* Ultra-Smooth Sidebar Mini Mode Transitions */
    .admin-sidebar,
    .admin-main,
    .brand-mark,
    .brand-copy,
    ...
    /* Transition behaviors for collapsed sidebar */
    @media (min-width: 992px) {
      /* Remove gaps to center icons perfectly */
      ...
      /* Gracefully shrink texts and copies */
      body.sidebar-mini .brand-copy,
      body.sidebar-mini .sidebar-nav .nav-text,
      ...
      /* Gracefully hide section headers */
      body.sidebar-mini .sidebar-section-header {
        height: 0;
        opacity: 0;
        padding: 0 !important;
        margin: 0 !important;
      ...
      body.sidebar-mini .sidebar-user span.position-absolute {
        opacity: 0;
        pointer-events: none;
      }
      body.sidebar-mini .sidebar-user-avatar {
        width: 38px;
        height: 38px;
        margin-bottom: 0 !important;
      }

      /* Align footer status dot */
      ...
      body.sidebar-mini .sidebar-nav .nav-link.active {
        border-radius: 8px !important;
      }
      body.sidebar-mini .sidebar-nav .nav-icon {
        margin: 0;
      }
    }
