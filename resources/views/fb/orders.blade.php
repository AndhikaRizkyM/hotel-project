...
@section('content')
    <div class="page-heading">
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <p class="text-muted mb-0">Manage kitchen order preparation, status updates, and track room service
                    deliveries.</p>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-xl-8">
            <div class="panel shadow-sm p-4">
                <div class="panel-header border-bottom mb-3 pb-3">
                    <h2 class="h5 mb-0 section-title"><i class="bi bi-fire text-danger"></i><span>Kitchen Preparation
                            Queue</span></h2>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-sm">
                        ...
                        <tbody>
                            @forelse($activeOrders as $order)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span
                                            class="badge bg-{{ $colors[$order->status] ?? 'secondary' }}">{{ $order->status }}</span>
                                    </td>
                                    <td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">No active room service orders in
                                        the queue.</td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        <div class="col-12 col-xl-4">
            <div class="card shadow-sm border-bottom p-3">
                <div class="card-body">
                    <h5 class="fw-bold border-bottom pb-3 mb-3"><i class="bi bi-clock-history"></i> Recent Completed Orders
                    </h5>
                        ...
                        <table class="table table-sm align-middle small mb-0">
                            ...
                            <tbody>
                                @forelse($completedOrders as $comp)
                                    <tr>
                                        <td><strong>#FNB-{{ $comp->id }}</strong><br><small
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $comp->status === 'Delivered' ? 'success' : 'secondary' }}">{{ $comp->status }}</span>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted">No completed orders history.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
