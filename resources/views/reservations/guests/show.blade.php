...
@section('content')
    <div class="page-heading">
        ...
        <div class="heading-actions">
            <a href="{{ route('fo.guests.index') }}" class="btn btn-light btn-tactile btn-sm"><i
                    class="bi bi-arrow-left"></i> Back to Directory</a>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-5">
            <div class="panel-premium shadow-sm">
                <div class="panel-header border-bottom mb-3 p-4">
                    <h2 class="h5 mb-0 section-title"><i class="bi bi-pencil-square text-primary"></i><span>Modify Identity
                            Details</span></h2>
                </div>
                    ...
                    <div class="row g-3 p-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="date" name="birth_date" id="birth_date"
                                value="{{ old('birth_date', $guest->birth_date) }}" class="form-control form-control-sm">
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select name="gender" id="gender" class="form-select form-select-sm">
                                <option value="Male" {{ old('gender', $guest->gender) === 'Male' ? 'selected' : '' }}>Male
                                </option>
                                <option value="Female" {{ old('gender', $guest->gender) === 'Female' ? 'selected' : '' }}>
                                    Female</option>
                            </select>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="country" id="country"
                                value="{{ old('country', $guest->country) }}" class="form-control form-control-sm">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="vehicle_no" id="vehicle_no"
                                value="{{ old('vehicle_no', $guest->vehicle_no) }}" class="form-control form-control-sm">
                        </div>
                        ...
                        <div class="col-12 mt-3 pt-2 border-top" style="border-top-color: var(--admin-border) !important;">
                            <button type="submit" class="btn btn-primary btn-tactile btn-sm w-100"><i
                                    class="bi bi-save"></i> Save Profile Modifications</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="col-12 col-lg-7">
            <div class="panel-premium shadow-sm h-100">
                <div class="panel-header border-bottom mb-3 p-4">
                    <h2 class="h5 mb-0 section-title"><i class="bi bi-clock-history text-primary"></i><span>Historical Room
                            Reservations</span></h2>
                </div>
                        ...
                        <tbody>
                            @forelse($guest->reservations as $res)
                                <tr>
                                    ...
                                    <td><span class="badge badge-soft-secondary">Room {{ $res->room->room_number }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span
                                            class="badge {{ $colors[$res->status] ?? 'badge-soft-secondary' }}">{{ $res->status }}</span>
                                    </td>
                                    <td>
                                        <a href="{{ route('fo.reservations.show', $res->id) }}"
                                            class="btn btn-light btn-tactile btn-xs py-1 px-3"><i
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">No reservations logged under
                                        this guest.</td>
                                </tr>
                            @endforelse
                        </tbody>
