            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 20%;">
                        ...
                        <div class="cell-value">{{ $reservation->number_of_guests }}</div>
                    </td>
                ...
                <tr>
                    ...
                    <td rowspan="3" style="width: 20%;">
                        ...
                        <div class="cell-value">{{ \Carbon\Carbon::parse($reservation->check_in_time ?? '14:00')->format('H:i') }}</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <div class="cell-value">{{ $reservation->guest->profession ?? '-' }}</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <div class="cell-value">{{ $reservation->guest->company ?? '-' }}</div>
                    </td>
                    <td rowspan="2">
                        <div class="label-ind">Tanggal Kedatangan</div>
                        <div class="label-eng">Arrival Date</div>
                        <div class="cell-value">
                            {{ \Carbon\Carbon::parse($reservation->check_in_date)->format('d M Y') }}</div>
                    </td>
                </tr>
                    ...
                    <td colspan="4">
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <div style="width: 33%;">
                                ...
                                <div class="cell-value">
                                    {{ $reservation->guest->birth_date ? \Carbon\Carbon::parse($reservation->guest->birth_date)->format('d M Y') : '-' }}</div>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        ...
                        <div class="cell-value">
                            {{ \Carbon\Carbon::parse($reservation->check_out_date)->format('d M Y') }}</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                ...
                                <div class="cell-value">{{ $reservation->guest->member_card_no ?? '-' }}</div>
                            </div>
                            <div>
                                ...
                                <div style="margin-top: 5px; font-size: 8.5pt;">
                                    <input type="checkbox" style="vertical-align: middle;" {{ str_contains(strtolower($payMethod), 'visa') || str_contains(strtolower($payMethod), 'credit') ? 'checked' : '' }}> VISA &nbsp;&nbsp;
                                    <input type="checkbox" style="vertical-align: middle;" {{ str_contains(strtolower($payMethod), 'debit') ? 'checked' : '' }}> Debit Card &nbsp;&nbsp;
                                    <input type="checkbox" style="vertical-align: middle;" {{ !str_contains(strtolower($payMethod), 'visa') && !str_contains(strtolower($payMethod), 'credit') && !str_contains(strtolower($payMethod), 'debit') ? 'checked' : '' }}> Other: {{ $payMethod }}
                                </div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="4" rowspan="2" style="padding: 10px;">
                        <div class="terms-text">
                            <strong>Kepada Park Hotel:</strong> Saya menyatakan bahwa saya baik sendiri ataupun
                            bersama-sama dengan perusahaan, asosiasi, perorangan or semuanya bertanggung jawab atas
                            pembayaran semua tagihan yang terjadi sehubungan dengan seluruh pelayanan yang Anda berikan
                            sesuai formulir pendaftaran ini. / <em>To Park Hotel: I acknowledge that I'm jointly and
                                severally liable with the fore-going person, company or association (and if more than
                                one all of them) for payment of the amount of any charges payable or incurred in
                                connection with all services provided by you under registration.</em>
                        </div>
                        <hr style="border: 0; border-top: 1px dotted #ccc; margin: 8px 0;">
                        <div class="terms-text">
                            • Untuk diketahui bahwa anda tidak diperkenankan untuk membawa durian ke area hotel. /
                            <em>Please be informed that you are not allowed to bring Durian into the hotel
                                premises.</em><br>
                            • Barang berharga (perhiasan, uang dsb) dapat anda simpan dalam brankas di kamar anda atau
                            di kantor depan. / <em>For your valuable belongings (jewels, money, etc), you can use the
                                safe deposit box in your room or front office.</em><br>
                            • Kamar ini bebas rokok. Denda sebesar Rp. 1.000.000,- akan ditagihkan apabila Anda merokok
                            di kamar ini. / <em>This room is designed as a non-smoking room. A fine of Rp. 1.000.000,-
                                will be charged for smoking in this room.</em>
                        </div>
                    </td>
                    <td rowspan="2" style="text-align: center; vertical-align: middle; height: 120px;">
                        <div class="label-ind" style="margin-bottom: 50px;">Tanda Tangan Tamu<br><span
                                class="label-eng">Guest Signature</span></div>
                        <div class="cell-value"
                             style="font-size: 8pt; font-weight: normal; border-top: 1px solid #000; padding-top: 3px;">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div class="cell-value">{{ $reservation->safety_deposit_box ?? '-' }}</div>
                    </td>
                    <td colspan="2">
